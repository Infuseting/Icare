...
CREATE TABLE IF NOT EXISTS `ICA_Classe` (
    ...
    PRIMARY KEY (`ETU_ID`, `TYPC_ID`, `NIV_ID`),
...
CREATE TABLE IF NOT EXISTS `ICA_FORMAT` (
                                            ...
                                            `ETU_ID` INT NOT NULL,
                                            `SEM_ID` INT NOT NULL,
                                            PRIMARY KEY (`MAT_ID`, `TYPC_ID`, `ETU_ID`, `SEM_ID`),
    INDEX `fk_ICA_Matiere_has_ICA_Type_Cours_ICA_Matiere1_idx` (`MAT_ID` ASC) VISIBLE,
    INDEX `fk_ICA_FORMAT_ICA_Type_Classe1_idx` (`TYPC_ID` ASC) VISIBLE,
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
    CONSTRAINT `fk_ICA_FORMAT_ICA_Type_Classe1`
    FOREIGN KEY (`TYPC_ID`)
    REFERENCES `ICA_Type_Classe` (`TYPC_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS `ICA_HERITE` (
                                            ...
                                            `TYPC_ID` INT NOT NULL,
                                            `NIV_ID` INT NOT NULL,
                                            `ANCETRE_NIV_ID` INT NOT NULL,
                                            `ANCETRE_ETU_ID` INT NOT NULL,
                                            `ANCETRE_TYPC_ID` INT NOT NULL,
                                            PRIMARY KEY (`ETU_ID`, `TYPC_ID`, `NIV_ID`, `ANCETRE_TYPC_ID`, `ANCETRE_ETU_ID`, `ANCETRE_NIV_ID`),
    INDEX `ACTUAL_idx` (`ANCETRE_NIV_ID` ASC, `ANCETRE_ETU_ID` ASC, `ANCETRE_TYPC_ID` ASC) VISIBLE,
    CONSTRAINT `ANCESTOR`
    FOREIGN KEY (`ETU_ID` , `TYPC_ID` , `NIV_ID`)
    REFERENCES `ICA_Classe` (`ETU_ID` , `TYPC_ID` , `NIV_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
    CONSTRAINT `ACTUAL`
    FOREIGN KEY (`ANCETRE_NIV_ID` , `ANCETRE_ETU_ID` , `ANCETRE_TYPC_ID`)
    REFERENCES `ICA_Classe` (`NIV_ID` , `ETU_ID` , `TYPC_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
    ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `ICA_Obligation_Cours` (
                                                      `OBG_ID` INT NOT NULL,
                                                      `AVANT_COU_ID` INT NOT NULL,
                                                      `MAT_ID` INT NOT NULL,
                                                      `TYPC_ID` INT NOT NULL,
                                                      `ETU_ID` INT NOT NULL,
                                                      `SEM_ID` INT NOT NULL,
                                                      PRIMARY KEY (`OBG_ID`),
    INDEX `fk_ICA_Obligation_Cours_ICA_Obligation_Cours1_idx` (`AVANT_COU_ID` ASC) VISIBLE,
    INDEX `fk_ICA_Obligation_Cours_ICA_FORMAT1_idx` (`MAT_ID` ASC, `TYPC_ID` ASC, `ETU_ID` ASC, `SEM_ID` ASC) VISIBLE,
    CONSTRAINT `fk_ICA_Obligation_Cours_ICA_Obligation_Cours1`
    FOREIGN KEY (`AVANT_COU_ID`)
    REFERENCES `ICA_Obligation_Cours` (`OBG_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
    CONSTRAINT `fk_ICA_Obligation_Cours_ICA_FORMAT1`
    FOREIGN KEY (`MAT_ID` , `TYPC_ID` , `ETU_ID` , `SEM_ID`)
    REFERENCES `ICA_FORMAT` (`MAT_ID` , `TYPC_ID` , `ETU_ID` , `SEM_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
    ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `ICA_Salle` (
                                           `SAL_ID` INT NOT NULL,
                                           `SAL_Libelle` VARCHAR(45) NOT NULL,
    `BAT_ID` INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ICA_Autorise` (
                                              `SAL_ID` INT NOT NULL,
                                              `ETU_ID` INT NOT NULL,
                                              `AUT_Utilisable` TINYINT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ICA_Cours` (
    ...
    INDEX `fk_ICA_Cours_ICA_Classe1_idx` (`ETU_ID` ASC, `TYPC_ID` ASC, `NIV_ID` ASC) VISIBLE,
